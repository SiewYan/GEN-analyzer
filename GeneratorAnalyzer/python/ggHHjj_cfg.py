...
process.source = cms.Source("PoolSource",
                ...
                #'file:$CMSSW_BASE/src/Sherpa-cmssw/Generator/ggHH_temp/ggHH2j_benchmark_noshower/sherpa_Run.root',
...
process.lamb = cms.EDAnalyzer("Analyzer",
                              genSet = cms.PSet(
                              ...
                              histFile = cms.string('%s/src/GEN-analyzer/GeneratorAnalyzer/data/HistList.dat' % os.environ['CMSSW_BASE']),
